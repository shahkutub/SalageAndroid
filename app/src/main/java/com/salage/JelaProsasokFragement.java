 ...
 */
public class JelaProsasokFragement extends BaseFragment {
    Context con;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.jelaprossasok, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //getdata();
        //sendRequest();
        requestOrderHistory(AllURL.jelaProsasokDataUrl());
    }
