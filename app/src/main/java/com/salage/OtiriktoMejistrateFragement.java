 ...
 */
public class OtiriktoMejistrateFragement extends BaseFragment {
    Context con;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.otirikto_jelaprossasok, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //getdata();
        //sendRequest();
        requestOrderHistory(AllURL.otiriktojelaProsasokDataUrl());
    }
